...
dataContext.attach = function (entity) {
    dataContext.manager.attachEntity(entity, entity.entityAspect.entityState);
}
dataContext.save = function (entity,type) {
	//dataContext.manager.attachEntity(entity, entity.entityAspect.entityState);
...
dataContext.getExercise = function (name) {
    var query = breeze.EntityQuery.from("Exersizes").where("Name", "==", name);

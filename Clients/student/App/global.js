define(['knockout','data'], function (ko,data) {
    function routes() {
        var routes = [
                    ...
                    { route: 'editid', moduleId: 'editid', title: '登录名', nav: 3 },
                    { route: 'editname', moduleId: 'editname', title: '名字', nav: 3 },
                    { route: 'editemail', moduleId: 'editemail', title: '邮件地址', nav: 3 },
                    { route: 'editmobile', moduleId: 'editmobile', title: '手机号码', nav: 3 },
